...
public class AutomaticLOD : MonoBehaviour
{
  ...
  void OnWillRenderObject()
  {
    ...
    if (IsDependent())
    {
      ...
      if(bCheck)
      {
        int nLODLevel = m_LODObjectRootPersist != null ? m_LODObjectRootPersist.GetLODLevelUsingCamera(Camera.main) : m_LODObjectRoot.GetLODLevelUsingCamera(Camera.main);
    ...
    else
    {
      if (m_originalMesh && b_performCheck)
      {
        ...
        int nLODLevel = GetLODLevelUsingCamera(Camera.main);
