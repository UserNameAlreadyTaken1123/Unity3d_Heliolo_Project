// simple fading script by Kentyman
...
public class FadeIn : MonoBehaviour{   
	...
	public bool startUpFadeIn;
	public float delayBeforeStarting = 0.1f;
	...
	public Color m_CurrentScreenOverlayColor = new Color(0,0,0,1);	// default starting color: black and fully transparrent
	...
	//esto esta mal. despues lo corrijo
	void Update(){
		if (startUpFadeIn) {
			startTimer += Time.deltaTime;
			if (startTimer >= delayBeforeStarting) {
				startUpFadeIn = false;
				StartFade (new Color (0, 0, 0, 0), timeToComplete);
			}
		}
	}
