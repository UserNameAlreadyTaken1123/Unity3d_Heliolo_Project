...
public class MeleeWeaponTrail : MonoBehaviour
{
	...
	public Material _materialBlue;
	public Material _materialGreen;
	public Material _materialGold;
	public Material _materialOrange;
	public Material _materialRed;
	public Material _materialYellow;
	...
	[SerializeField]
	//modified to make weapon's code somewhat more independant
	...
	void Start()
	{
		...
		/*
		if (Player == null && GameObject.Find ("PlayerSpawn"))
			_trailObject.transform.parent = GameObject.Find ("PlayerSpawn").transform;
		else if (Player)
			_trailObject.transform.parent = Player.transform;
		else
			Destroy (this);
