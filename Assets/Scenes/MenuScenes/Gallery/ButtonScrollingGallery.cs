...
public class ButtonScrollingGallery : MonoBehaviour {
	...
	public GameObject displayedElement;
	...
	void Update () {
			...
			if (update) {
				foreach (GameObject buttonSelected in Buttons) {
					if (Buttons.IndexOf (buttonSelected) == listIndex) {
						...
						if (buttonSelected.GetComponent<ButtonActionGallery> ().ElementToDisplay != null) {	
							displayedElement = buttonSelected.GetComponent<ButtonActionGallery> ().ElementToDisplay;
		...
		if (InputManager.GetButtonDown ("Jump")) {
			...
			Buttons[listIndex].gameObject.GetComponent<ButtonActionGallery>().PerformButtonAction();
		}
	}
